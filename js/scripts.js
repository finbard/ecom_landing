...
(function($) {
  ...
  // Code for Submitting Contact Forms!

  $( document ).ready(function() {
      $('#submit-request-form').on('click', function(e) {
        e.preventDefault();
        var jqxhr = $.ajax({
          url: 'https://script.google.com/macros/s/AKfycbzl5jJbpXl52Id-JKr_4VpdrJnS6X8Rdv5kiY9sVoaR8zzT5T8/exec',
          method: "GET",
          dataType: "json",
          data: $("#requestForm").serialize(),
          success: function() {
              $("#requestForm").html('Thanks for getting in touch! We will be in contact shortly!')
          },
          error: function() {
              $("#requestForm").html('Something went wrong - please try again later.')
              console.log('Error occured with sending contact information');
          }
        })
      })
  });
